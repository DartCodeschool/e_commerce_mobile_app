    ...
    return Column(
      children: [
        ...
        Expanded(
          ...
          children: [
            Text('Selected Item ($answer)', style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 20, color: Colors.black87)),
            const SizedBox(height: 40),
            ElevatedButton(style: ButtonStyle(backgroundColor: const MaterialStatePropertyAll(Colors.green), minimumSize: const MaterialStatePropertyAll(Size(330, 50)), shape: MaterialStatePropertyAll(RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)))), onPressed: () {}, child: const Text('Checkout', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w700))),
          ],
        )),
      ],
    );
